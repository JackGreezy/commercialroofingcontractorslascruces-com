...
html body header,html body #header,html body [id="header"],html body .site-header,html body .main-header,html body .olrhjel-location-header,html body [class*="Header_header"],html body [class*="site-header"]{{background:linear-gradient(135deg,var(--rh-primary),var(--rh-secondary))!important;color:#fff!important;}}
html body header a,html body #header a,html body .site-header a,html body .main-header a,html body .olrhjel-location-header a,html body [class*="Header_header"] a{{color:#fff!important;}}
html body footer,html body #footer,html body .site-footer,html body .olrhjel-location-footer,html body [class*="Footer"],html body [class*="footer"]{{background:linear-gradient(135deg,var(--rh-primary),#101820)!important;color:#fff!important;}}
html body footer a,html body #footer a,html body .site-footer a,html body .olrhjel-location-footer a,html body [class*="Footer"] a,html body [class*="footer"] a{{color:#fff!important;}}
html body .rr-wordmark .rr-wm-1,html body .rr-wordmark .rr-wm-2{{color:inherit!important;}}
html body a[class*="btn"],html body a[class*="button"],html body button:not(.slick-arrow):not([aria-label*="Close"]),html body input[type="submit"],html body .btn,html body .button,html body .wp-block-button__link,html body .olrhjel-button,html body [class*="Button"],html body [class*="button"]{{background:var(--rh-accent)!important;border-color:var(--rh-accent)!important;color:var(--rh-button-text)!important;box-shadow:none;}}
